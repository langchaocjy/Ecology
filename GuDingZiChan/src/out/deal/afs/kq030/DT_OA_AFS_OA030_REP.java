 ...
 */
            ...
            /**
            *  DT_OA_AFS_OA030_REP bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DT_OA_AFS_OA030_REP
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = DT_OA_AFS_OA030_REP
                ...
                */
                        ...
                        */
                                    ...
                                    protected out.deal.afs.kq030.DETAIL_type0[] localDETAIL ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return out.deal.afs.bk2.DETAIL_type0[]
                           */
                           public  out.deal.afs.kq030.DETAIL_type0[] getDETAIL(){
                               return localDETAIL;
                           }
                               ...
                               */
                              protected void validateDETAIL(out.deal.afs.kq030.DETAIL_type0[] param){
                              ...
                              * @param param DETAIL
                              */
                              public void setDETAIL(out.deal.afs.kq030.DETAIL_type0[] param){
                             ...
                             * @param param out.deal.afs.bk2.DETAIL_type0
                             */
                             public void addDETAIL(out.deal.afs.kq030.DETAIL_type0 param){
                                   if (localDETAIL == null){
                                   localDETAIL = new out.deal.afs.kq030.DETAIL_type0[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localDETAIL);
                               list.add(param);
                               this.localDETAIL =
                             (out.deal.afs.kq030.DETAIL_type0[])list.toArray(
                            new out.deal.afs.kq030.DETAIL_type0[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DT_OA_AFS_OA030_REP",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DT_OA_AFS_OA030_REP",
                                       ...
                                       if (localDETAIL!=null){
                                            for (int i = 0;i < localDETAIL.length;i++){
                                                if (localDETAIL[i] != null){
                                                 localDETAIL[i].serialize(new javax.xml.namespace.QName("","DETAIL"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static DT_OA_AFS_OA030_REP parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DT_OA_AFS_OA030_REP object =
                new DT_OA_AFS_OA030_REP();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DT_OA_AFS_OA030_REP".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DT_OA_AFS_OA030_REP)out.deal.afs.kq030.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    list3.add(out.deal.afs.kq030.DETAIL_type0.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","DETAIL").equals(reader.getName())){
                                                                    list3.add(out.deal.afs.kq030.DETAIL_type0.Factory.parse(reader));
                                                        ...
                                                        object.setDETAIL((out.deal.afs.kq030.DETAIL_type0[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                out.deal.afs.kq030.DETAIL_type0.class,
                                                                list3));
