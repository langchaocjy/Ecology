 ...
 */
            ...
            /**
            *  DT_FI_OA_AFS_OA031_REP bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DT_FI_OA_AFS_OA031_REP
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = DT_FI_OA_AFS_OA031_REP
                ...
                */
                        ...
                        */
                                    ...
                                    protected out.deal.afs.zc031.DATA_type0[] localDATA ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  out.deal.afs.zc031.DATA_type0[] getDATA(){
                               return localDATA;
                           }
                               ...
                               */
                              protected void validateDATA(out.deal.afs.zc031.DATA_type0[] param){
                              ...
                              * @param param DATA
                              */
                              public void setDATA(out.deal.afs.zc031.DATA_type0[] param){
                             ...
                             * @param param out.deal.afs.bk2.DATA_type0
                             */
                             public void addDATA(out.deal.afs.zc031.DATA_type0 param){
                                   if (localDATA == null){
                                   localDATA = new out.deal.afs.zc031.DATA_type0[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localDATA);
                               list.add(param);
                               this.localDATA =
                             (out.deal.afs.zc031.DATA_type0[])list.toArray(
                            new out.deal.afs.zc031.DATA_type0[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DT_FI_OA_AFS_OA031_REP",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static DT_FI_OA_AFS_OA031_REP parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DT_FI_OA_AFS_OA031_REP object =
                new DT_FI_OA_AFS_OA031_REP();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DT_FI_OA_AFS_OA031_REP".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DT_FI_OA_AFS_OA031_REP)out.deal.afs.zc031.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    list3.add(out.deal.afs.zc031.DATA_type0.Factory.parse(reader));
                                                        ...
                                                        object.setDATA((out.deal.afs.zc031.DATA_type0[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                out.deal.afs.zc031.DATA_type0.class,
                                                                list3));
