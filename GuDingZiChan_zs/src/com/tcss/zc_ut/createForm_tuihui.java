 ...
 * 资产采购单订单创建
 * */
public class createForm_tuihui extends BaseBean implements Action{
	...
	public String execute(RequestInfo ri) {
		String src = ri.getRequestManager().getSrc();
		...
		if (src.equals("reject")) {
			try 
			{
				...
				mainData.put("zoast", 2);
				int times2 = Integer.parseInt(mainData.getString("times2"));
				 times2 += 1;
				mainData.put("times2", times2);
				...
				if(subrc.equals("S"))
				{
					String sql3 = "update formtable_main_187 set times2='"+mainData.getString("times2")+"' "
