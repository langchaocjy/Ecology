 ...
 */
            ...
            /**
            *  ET_RETURN_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ET_RETURN_type0
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ET_RETURN_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ET_RETURN_type0",
    ...
    public static class Factory{
        ...
        */
        public static ET_RETURN_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ET_RETURN_type0 object =
                new ET_RETURN_type0();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ET_RETURN_type0".equals(type)){
                                ...
                                return (ET_RETURN_type0)out.deal.afs.zc006.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
