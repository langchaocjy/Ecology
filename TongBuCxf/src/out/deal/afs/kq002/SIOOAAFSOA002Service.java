...
public class SIOOAAFSOA002Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/eclipse-myeclipse-code/eclipse-code/TongBuCxf/002.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SIOOAAFSOA002Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/eclipse-myeclipse-code/eclipse-code/TongBuCxf/002.wsdl");
        }
        WSDL_LOCATION = url;
    }
