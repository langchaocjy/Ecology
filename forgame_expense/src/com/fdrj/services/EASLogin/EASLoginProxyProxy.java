...
public class EASLoginProxyProxy implements com.fdrj.services.EASLogin.EASLoginProxy {
  private String _endpoint = null;
  private com.fdrj.services.EASLogin.EASLoginProxy eASLoginProxy = null;
  ...
  private void _initEASLoginProxyProxy() {
    try {
      eASLoginProxy = (new com.fdrj.services.EASLogin.EASLoginProxyServiceLocator()).getEASLogin();
  ...
  public com.fdrj.services.EASLogin.EASLoginProxy getEASLoginProxy() {
    if (eASLoginProxy == null)
      _initEASLoginProxyProxy();
