...
public class PageUtil<T> {
	...
	public String displayForPage(String method) {
		...
		sb.append("<span style=\"height:30px;line-height:30px;color:#666666;\">第<input style=\"color:#666666;line-height:22px;text-align:center;border:0px;outline:none;\" type=\"text\" size=\"2\" name=\"page1\" id=\"page1\" value=" + this.page + ">" + "页&nbsp;&nbsp;</span>");
		sb.append("<input class=\"e8_btn_top_first\"   type=\"button\" value=\"跳转\"   onclick=\"" + method + "(document.getElementById('page1').value)\">");

		sb.append("<select name=\"pageRecorders\" id=\"pageRecorders\"  onchange=\"" + method + "(document.getElementById('page1').value)\"><option value=\"10\"  " + ((this.pageRecorders == 10) ? "selected" : "") + "  >10</option><option value=\"20\"   " + ((this.pageRecorders == 20) ? "selected" : "") + "  >20</option><option value=\"50\" " + ((this.pageRecorders == 50) ? "selected" : "") + " >50</option><option value=\"100\" " + ((this.pageRecorders == 100) ? "selected" : "") + " >100</option></select>");
