		...
		try {
			...
			if (hrmjobtitles != null) {
				...
				for (int i = 0; i < hrmjobtitles.length; i++) {
					...
					// String jobtitlename =
					// null2String(hrmjobtitles_type0.getJobtitlename());
		...
		try {
			...
			if (s != null) {
				...
				for (int i = 0; i < s.length; i++) {
					...
					String field3 = null2String(user.getWERKS());//人事范围
                    String field4 = null2String(user.getBTRTL());//人事子范围
                    String field5 = null2String(user.getPERSG());//员工组
                    String field6 = null2String(user.getPERSK());//员工子组
                    String field7 = null2String(user.getBEGDA());//入职日期
					...
					json.put("人事范围",field3);
					json.put("人事子范围",field4);
					json.put("员工组",field5);
					json.put("员工子组",field6);
					json.put("入职日期",field7);
					json.put("工时制", ansvh);
					json.put("考勤方式", zterf);
					json.put("排班", schkz);
