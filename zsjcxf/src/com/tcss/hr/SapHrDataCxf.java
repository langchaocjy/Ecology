  ...
  public SapHrDataCxf()
  {
    ...
    try
    {
      ...
      for (int i = 0; i < sheets.size(); i++)
      {
        ...
        String field3 = null2String(user.getWERKS());
        String field4 = null2String(user.getBTRTL());
        String field5 = null2String(user.getPERSG());
        String field6 = null2String(user.getPERSK());
        String field7 = null2String(user.getBEGDA());
